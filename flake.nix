{
  ...
  outputs = { self, nixos, nixpkgs, nixpkgsHM, monolisa }:
    let
      commonPkgs = pkgset: system:
        let
          pkgs = import pkgset {
            system = system;
    ...
    {
      nixosConfigurations = {
        "jayesh@Jayeshs-Thinkpad-E431" = nixos.lib.nixosSystem {
          system = "x86_64-linux";
          modules =
            [
      ...
      homeConfigurations = {
        ...
        "jayesh@Jayeshs-Mac-Mini-2018.local" = nixpkgsHM.lib.homeManagerConfiguration rec {
          system = "x86_64-darwin";
          username = "jayesh";
          homeDirectory = "/Users/${username}";
          configuration = {
            nixpkgs.config.allowUnfree = true;
            home.packages = (commonPkgs nixpkgs system) ++ (darwinPkgs system);
          };
        };

        "jayesh@Jayeshs-Macbook-Pro-13-M1-2020.local" = nixpkgsHM.lib.homeManagerConfiguration rec {
        ...
        # "jayesh@Jayeshs-Thinkpad-E431" = nixosHM.lib.homeManagerConfiguration rec {
        #   system = "x86_64-linux";
        #   username = "jayesh";
        #   homeDirectory = "/home/${username}";
        #   configuration = {
        #     nixos.config.allowUnfree = true;
        #     home.packages = (commonPkgs nixos system) ++ (nixosPkgs system);
        #   };
        # };
      };
    };
